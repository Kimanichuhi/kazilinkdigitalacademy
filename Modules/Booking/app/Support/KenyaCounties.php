...
/**
 * Kenya's 47 counties mapped to their constituencies (IEBC 2012 delimitation,
 * unchanged since). Authored from general knowledge for this feature —
 * spot-check against the official IEBC constituency list before relying on
 * it for anything beyond a form dropdown.
 */
class KenyaCounties
{
