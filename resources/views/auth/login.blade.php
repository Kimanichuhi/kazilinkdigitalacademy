            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div x-data="{ show: false }">
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <a href="{{ route('password.request') }}" class="text-xs text-brand-600 hover:underline font-medium">Forgot password?</a>
                        </div>
                        <div class="relative">
                            <input
                                id="password"
                ...
                <div class="mt-6 text-center space-y-3">
                    <p class="text-sm text-muted-foreground">
                        ...
                        <a href="{{ route('register') }}" class="text-brand-600 hover:underline font-medium">Register here</a>
                    </p>
                    <p class="text-sm text-muted-foreground">
                        <a href="{{ url('/') }}" class="text-brand-600 hover:underline">&larr; Back to website</a>
                    </p>
                </div>
            </div>
        </div>
